...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Formation.niveau_sortie'
        db.add_column('formation_formation', 'niveau_sortie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formation.NiveauUniversitaire'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Formation.niveau_sortie'
        db.delete_column('formation_formation', 'niveau_sortie_id')
