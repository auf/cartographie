...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JetonPassword'
        db.create_table('formation_jetonpassword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('jeton', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('creation', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Personne.utilisateur'
        db.delete_column('formation_personne', 'utilisateur_id')

        # Deleting field 'Personne.jeton_password'
        db.delete_column('formation_personne', 'jeton_password_id')
