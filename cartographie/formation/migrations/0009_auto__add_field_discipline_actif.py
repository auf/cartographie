...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discipline.actif'
        db.add_column('formation_config_discipline', 'actif',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discipline.actif'
        db.delete_column('formation_config_discipline', 'actif')
