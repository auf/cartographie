...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FormationModification.user'
        db.alter_column('formation_formationmodification', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FormationModification.user'
        raise RuntimeError("Cannot reverse this migration. 'FormationModification.user' and its values cannot be restored.")
