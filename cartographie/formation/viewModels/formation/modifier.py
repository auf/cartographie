...
class ModifierViewModel(BaseModifierViewModel):
    ...
    """Les données nécessaires à la view "modifier" et
    "modifier_etablissements" sont obtenues et gérées ici."""
    ...
    def __init__(self, request, token, formation_id, presence_formsets=False):
        ...
        if token:
            ...
            def limiter_choix_etablissement(field, **kwargs):
                """Cette fonction est utilisée en callback par
            ...
            def limiter_choix_partenaire_autre(field, **kwargs):
                """Limite les choix des partenaires non nembres de l'AUF aux
                partenaires qui sont associés à l'établissement qui donne la
                formation"""
