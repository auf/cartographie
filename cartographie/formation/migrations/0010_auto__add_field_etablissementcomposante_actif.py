...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EtablissementComposante.actif'
        db.add_column('formation_etablissementcomposante', 'actif',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EtablissementComposante.actif'
        db.delete_column('formation_etablissementcomposante', 'actif')
