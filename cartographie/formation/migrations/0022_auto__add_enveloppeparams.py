...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnveloppeParams'
        db.create_table('formation_enveloppeparams', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('enveloppe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='auf_enveloppe', to=orm['mailing.Enveloppe'])),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('url', self.gf('django.db.models.fields.TextField')()),
            ('courriel_destinataire', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('formation', ['EnveloppeParams'])


    def backwards(self, orm):
        # Deleting model 'EnveloppeParams'
        db.delete_table('formation_enveloppeparams')
