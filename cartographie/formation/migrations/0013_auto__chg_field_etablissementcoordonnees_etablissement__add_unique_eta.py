...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EtablissementCoordonnees.etablissement'
        db.alter_column('formation_config_etablissementcoordonnees', 'etablissement_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['references.Etablissement']))
        # Adding unique constraint on 'EtablissementCoordonnees', fields ['etablissement']
        db.create_unique('formation_config_etablissementcoordonnees', ['etablissement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EtablissementCoordonnees', fields ['etablissement']
        db.delete_unique('formation_config_etablissementcoordonnees', ['etablissement_id'])


        # Changing field 'EtablissementCoordonnees.etablissement'
        db.alter_column('formation_config_etablissementcoordonnees', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Etablissement']))
