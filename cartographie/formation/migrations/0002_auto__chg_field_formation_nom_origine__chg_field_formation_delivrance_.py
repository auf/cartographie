...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Formation.nom_origine'
        db.alter_column('formation_formation', 'nom_origine', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Formation.delivrance_diplome'
        db.alter_column('formation_formation', 'delivrance_diplome_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['formation.DelivranceDiplome']))

        # Changing field 'Formation.type_formation'
        db.alter_column('formation_formation', 'type_formation_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['formation.TypeFormation']))

        # Changing field 'Formation.niveau_diplome'
        db.alter_column('formation_formation', 'niveau_diplome_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['formation.NiveauDiplome']))

        # Changing field 'Formation.url'
        db.alter_column('formation_formation', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Formation.duree'
        db.alter_column('formation_formation', 'duree', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Formation.type_diplome'
        db.alter_column('formation_formation', 'type_diplome_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['formation.TypeDiplome']))

        # Changing field 'Formation.sigle'
        db.alter_column('formation_formation', 'sigle', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Formation.presentation'
        db.alter_column('formation_formation', 'presentation', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Formation.nom_origine'
        db.alter_column('formation_formation', 'nom_origine', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # User chose to not deal with backwards NULL issues for 'Formation.delivrance_diplome'
        raise RuntimeError("Cannot reverse this migration. 'Formation.delivrance_diplome' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Formation.type_formation'
        raise RuntimeError("Cannot reverse this migration. 'Formation.type_formation' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Formation.niveau_diplome'
        raise RuntimeError("Cannot reverse this migration. 'Formation.niveau_diplome' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Formation.url'
        raise RuntimeError("Cannot reverse this migration. 'Formation.url' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Formation.duree'
        raise RuntimeError("Cannot reverse this migration. 'Formation.duree' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Formation.type_diplome'
        raise RuntimeError("Cannot reverse this migration. 'Formation.type_diplome' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Formation.sigle'
        raise RuntimeError("Cannot reverse this migration. 'Formation.sigle' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Formation.presentation'
        raise RuntimeError("Cannot reverse this migration. 'Formation.presentation' and its values cannot be restored.")
