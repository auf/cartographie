...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Personne.telephone'
        db.alter_column('formation_personne', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Personne.courriel'
        db.alter_column('formation_personne', 'courriel', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'Personne.fonction'
        db.alter_column('formation_personne', 'fonction', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Personne.telephone'
        db.alter_column('formation_personne', 'telephone', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Personne.courriel'
        db.alter_column('formation_personne', 'courriel', self.gf('django.db.models.fields.EmailField')(default=None, max_length=75))

        # Changing field 'Personne.fonction'
        db.alter_column('formation_personne', 'fonction', self.gf('django.db.models.fields.CharField')(default=None, max_length=150))
