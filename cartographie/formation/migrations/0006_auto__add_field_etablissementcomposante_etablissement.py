...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EtablissementComposante.etablissement'
        db.add_column('formation_etablissementcomposante', 'etablissement',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['references.Etablissement']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EtablissementComposante.etablissement'
        db.delete_column('formation_etablissementcomposante', 'etablissement_id')
