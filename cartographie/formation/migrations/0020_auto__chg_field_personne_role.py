...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Personne.role' to match new field type.
        db.rename_column('formation_personne', 'role_id', 'role')
        # Changing field 'Personne.role'
        db.alter_column('formation_personne', 'role', self.gf('django.db.models.fields.CharField')(max_length=25))
        # Removing index on 'Personne', fields ['role']
        db.delete_index('formation_personne', ['role_id'])


    def backwards(self, orm):
        # Adding index on 'Personne', fields ['role']
        db.create_index('formation_personne', ['role_id'])


        # Renaming column for 'Personne.role' to match new field type.
        db.rename_column('formation_personne', 'role', 'role_id')
        # Changing field 'Personne.role'
        db.alter_column('formation_personne', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formation.UserRole']))
