...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EtablissementCoordonnees'
        db.create_table('formation_config_etablissementcoordonnees', (
        ...
        db.send_create_signal('formation', ['EtablissementCoordonnees'])


    def backwards(self, orm):
        # Deleting model 'EtablissementCoordonnees'
        db.delete_table('formation_config_etablissementcoordonnees')
