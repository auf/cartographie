...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CourrielRappel.nom'
        db.delete_column('formation_courrielrappel', 'nom')

        # Deleting field 'CourrielRappel.template'
        db.delete_column('formation_courrielrappel', 'template')

        # Deleting field 'CourrielRappel.actif'
        db.delete_column('formation_courrielrappel', 'actif')

        # Deleting field 'CourrielRappel.id'
        db.delete_column('formation_courrielrappel', 'id')

        # Adding field 'CourrielRappel.modelecourriel_ptr'
        db.add_column('formation_courrielrappel', 'modelecourriel_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['mailing.ModeleCourriel'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CourrielRappel.nom'
        raise RuntimeError("Cannot reverse this migration. 'CourrielRappel.nom' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CourrielRappel.template'
        raise RuntimeError("Cannot reverse this migration. 'CourrielRappel.template' and its values cannot be restored.")
        # Adding field 'CourrielRappel.actif'
        db.add_column('formation_courrielrappel', 'actif',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CourrielRappel.id'
        raise RuntimeError("Cannot reverse this migration. 'CourrielRappel.id' and its values cannot be restored.")
        # Deleting field 'CourrielRappel.modelecourriel_ptr'
        db.delete_column('formation_courrielrappel', 'modelecourriel_ptr_id')
    ...
    models = {
        ...
        'formation.etablissementcoordonnees': {
            'Meta': {'object_name': 'EtablissementCoordonnees', 'db_table': "'formation_config_etablissementcoordonnees'"},
            'etablissement': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'coordonnees'", 'unique': 'True', 'to': "orm['references.Etablissement']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'formation.formation': {
            ...
            'niveau_sortie': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['formation.NiveauUniversitaire']", 'null': 'True', 'blank': 'True'}),
            ...
            'statut': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
