...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EtablissementComposante.ville'
        db.alter_column('formation_etablissementcomposante', 'ville', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'EtablissementComposante.url'
        db.alter_column('formation_etablissementcomposante', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'EtablissementComposante.pays'
        db.alter_column('formation_etablissementcomposante', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Pays'], null=True))

        # Changing field 'EtablissementComposante.nom_origine'
        db.alter_column('formation_etablissementcomposante', 'nom_origine', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'EtablissementComposante.sigle'
        db.alter_column('formation_etablissementcomposante', 'sigle', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'EtablissementComposante.ville'
        db.alter_column('formation_etablissementcomposante', 'ville', self.gf('django.db.models.fields.CharField')(default=None, max_length=150))

        # Changing field 'EtablissementComposante.url'
        db.alter_column('formation_etablissementcomposante', 'url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'EtablissementComposante.pays'
        db.alter_column('formation_etablissementcomposante', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['references.Pays']))

        # Changing field 'EtablissementComposante.nom_origine'
        db.alter_column('formation_etablissementcomposante', 'nom_origine', self.gf('django.db.models.fields.CharField')(default=None, max_length=150))

        # Changing field 'EtablissementComposante.sigle'
        db.alter_column('formation_etablissementcomposante', 'sigle', self.gf('django.db.models.fields.CharField')(default=None, max_length=150))
