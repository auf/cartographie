...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for formation in orm['formation.Formation'].objects.all():
            if formation.statut == 888: # Archivage
                formation.statut = STATUTS.en_redaction
                formation.save()

    def backwards(self, orm):
        raise RuntimeError(u"Migration non réversible, puisque qu'une formation en rédaction n'était pas nécessairement archivée.")
