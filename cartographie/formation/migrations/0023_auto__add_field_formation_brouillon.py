...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Formation.brouillon'
        db.add_column('formation_formation', 'brouillon',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='publication_originale', unique=True, null=True, to=orm['formation.Formation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Formation.brouillon'
        db.delete_column('formation_formation', 'brouillon_id')
    ...
    models = {
        ...
        'formation.enveloppeparams': {
            'Meta': {'object_name': 'EnveloppeParams'},
            'courriel_destinataire': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'enveloppe': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'auf_enveloppe'", 'to': "orm['mailing.Enveloppe']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'formation.formation': {
            ...
            'brouillon': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'publication_originale'", 'unique': 'True', 'null': 'True', 'to': "orm['formation.Formation']"}),
