...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('formation_formation', 'brouillon',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['formation.Formation'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'formation.formation': {
            ...
            'brouillon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['formation.Formation']", 'blank': 'True'}),
